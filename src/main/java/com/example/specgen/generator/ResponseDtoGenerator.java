...
public class ResponseDtoGenerator implements Generator{
	private final TemplateWriter writer;
    private final JavaFormatter formatter;
    private Entity entity;
    private String content;

    public ResponseDtoGenerator(TemplateWriter writer, JavaFormatter formatter, Entity entity) {
        this.writer = writer;
        this.formatter = formatter;
		this.entity = entity;
    }

	public ResponseDtoGenerator(TemplateWriter writer, JavaFormatter formatter) {
        this.writer = writer;
        this.formatter = formatter;
    }
	...
	public void generate() throws Exception{
		...
		this.content = writer.render("response-dto.ftl",model);
	}
	...
	public String getName(){
		return entity.getName() + "ResponseDto.java";
	}
