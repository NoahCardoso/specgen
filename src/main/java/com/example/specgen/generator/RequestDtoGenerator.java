...
public class RequestDtoGenerator implements Generator{
	private final TemplateWriter writer;
    private final JavaFormatter formatter;
    private Entity entity;
    private String content;

    public RequestDtoGenerator(TemplateWriter writer, JavaFormatter formatter, Entity entity) {
        this.writer = writer;
        this.formatter = formatter;
		this.entity = entity;
    }

	public RequestDtoGenerator(TemplateWriter writer, JavaFormatter formatter) {
        this.writer = writer;
        this.formatter = formatter;
    }
	...
	public void generate() throws Exception{
		...
		this.content = writer.render("request-dto.ftl",model);
	}
	...
	public String getName(){
		return entity.getName() + "RequestDto.java";
	}
